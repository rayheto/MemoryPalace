...
| [spi-architecture.md](spi-architecture.md) | SPI 通信架构全解析：三进程拓扑、hardware/control/navigation 职责分离、共享内存仲裁协议、读写帧完整字段映射、健康监控、二进制符号反推 |
...
│   ├── hardware_task_tinker     # 硬件 SPI 驱动 (645KB, ARM64 Linux ELF, 无源码)
